...
export const metadata = {
  title: "Full-Service Interior Design — Siamo Design",
  description:
    "Comprehensive interior design with end-to-end project management, bespoke sourcing, and installation by Siamo Design.",
};
